const styles = {
  "@global": {
    ":root": {
      ...
      buttonBarActiveBackgroundColor:
      ...
      materialProgressCirclePrimaryColor:
        "var(\r\n    --material-progress-bar-primary-color\r\n  )",
      materialProgressCircleSecondaryColor:
    ...
    ".range--material__focus-ring::-webkit-slider-thumb": {
      ...
      fallbacks: [
        ...
        {
          transition:
            "opacity 0.25s ease-out, -webkit-transform 0.25s ease-out",
        },
      ],
    },
    ...
    "@media (-webkit-min-device-pixel-ratio: 2),\r\n  (min-resolution: 192dpi),\r\n  (min-resolution: 2dppx)":
      {
        ...
        ".list-item--material__left:empty, .list-item--material__center": {
          backgroundImage:
            "linear-gradient(0deg, #eee, #eee 50%, transparent 50%)",
        },
        ...
        ".list-header--material:not(:first-of-type)": {
          backgroundImage:
            "linear-gradient(180deg, #eee, #eee 50%, transparent 50%)",
        },
    ...
    ".checkbox--material__checkmark:before": {
      ...
      transition:
        "background-color 0.1s linear 0.2s, border-color 0.1s linear 0.2s",
      backgroundColor: "transparent",
    },
    ...
    ".checkbox--material__input:before": {
      ...
      transition:
        "opacity 0.25s ease-out, transform 0.1s ease-out,\r\n    -webkit-transform 0.1s ease-out",
      fallbacks: [
        {
    ...
    ".text-input--material__label--active": {
      ...
      transition:
        "transform 0.1s ease-in, color 0.1s ease-in,\r\n    -webkit-transform 0.1s ease-in",
      fallbacks: [
        {
    ...
    ".progress-bar--indeterminate:before": {
      ...
      webkitAnimation:
        "progress-bar__indeterminate 2.1s\r\n    cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite",
      animation:
        "progress-bar__indeterminate 2.1s\r\n    cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite",
      borderRadius: "4px",
    },
    ".progress-bar--indeterminate:after": {
      ...
      willChange: "left, right",
      webkitAnimation:
        "progress-bar__indeterminate-short 2.1s\r\n    cubic-bezier(0.165, 0.84, 0.44, 1) infinite",
      animation:
        "progress-bar__indeterminate-short 2.1s\r\n    cubic-bezier(0.165, 0.84, 0.44, 1) infinite",
